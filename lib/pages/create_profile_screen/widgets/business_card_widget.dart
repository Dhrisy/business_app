...
class BusinessCardWidget extends StatefulWidget {
  const BusinessCardWidget({ Key? key,
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              verticalGap,
              const Text("Information entered here is displayed publicly to match you with the right set of investors and buyers",
              style: TextStyle(
                fontWeight: FontWeight.w300
              ),),
              verticalGap,
              Text("Name of the business",  style: textStyle,),
              verticalGap,
              ReusableTextfield(
              ...
              verticalGap,
              Text("Business website", style: textStyle,),
              verticalGap,
              ReusableTextfield(
              ...
              verticalGap,
              Text("Who do you bank with",  style: textStyle,),
              verticalGap,
              ReusableTextfield(
              ...
              Text("Basic Information",   textAlign: TextAlign.center,
                  style: TextStyle(
                   fontSize: 16.sp,
              ...
              verticalGap,
              ReusableTextfield(controller: widget.businessIndustry,
              validation: (_){
              ...
              verticalGap,
              Text("Year Established",  style: textStyle,),
              verticalGap,
              ReusableTextfield(controller: widget.businessEstablishedYear,
              validation: (_){
              ...
              verticalGap,
              Text("Number of employees",  style: textStyle,),
              verticalGap,
              ReusableTextfield(controller: widget.businessNumberOfEmployees,
              validation: (_){
